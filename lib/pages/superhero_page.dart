          ...
          Padding(
            ...
            child: Column(
              ...
              children: [Center(
                ...
                BioWidget(bio: 'Full name', bioInfo: biography.fullName),
                const SizedBox(height: 20),
                BioWidget(bio: 'Aliases', bioInfo: biography.aliases.join(', ')),
                const SizedBox(height: 20),
                BioWidget(
                    bio: 'Place of birth', bioInfo: biography.placeOfBirth),
              ],
            ),
          ),
          Align(
              alignment: Alignment.topRight,
              child: AlignmentWidget(alignmentInfo: biography.alignmentInfo!))
        ],
      ),
    );
  }
...
class BioWidget extends StatelessWidget {
  ...
  const BioWidget({Key? key, required this.bio, required this.bioInfo})
      : super(key: key);
